...
Const nPixelWidth = 16			' 单个字符位图的宽度
Const nPixelHeight = 16			' 单个字符位图的高度
Const nColorHue = -2			' 显示验证码的色调(-1表示随机色调, -2表示灰度色调)'220
Const nAngleRandom = 2         ' 角度随机量
...
Randomize
Call CreatValidCode("securecode")
